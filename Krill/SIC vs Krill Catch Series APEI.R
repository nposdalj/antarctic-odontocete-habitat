...
# Load data
df <- read.csv(
  "L:/Shared drives/Antarctic Marine Mammals/Krill Data/Sofie's Analysis/APEI_krill_env_monthly.csv",
  header = TRUE
)

df_year <- read.csv(
  "L:/Shared drives/Antarctic Marine Mammals/Krill Data/Sofie's Analysis/APEI_krill_env_yearly.csv",
  header = TRUE
)
...
png(file.path(out_dir, "APEI_monthly_same_year_SIC_vs_krill.png"),
...
plot_krill_lm_black(
  ...
  xvar = "ice_lag0y",
  yvar = "krill_weight",
  main = "APEI Monthly: Same-Year SIC vs Krill Catch",
...
png(file.path(out_dir, "APEI_monthly_SIC_vs_krill_lags_2x2.png"),
...
png(file.path(out_dir, "APEI_yearly_same_year_SIC_vs_krill.png"),
    width = 2000, height = 1600, res = 300)
...
plot_krill_lm_black(
  ...
  xvar = "ice_pct",
  yvar = "total_krill",
  main = "APEI Yearly: Same-Year SIC vs Krill Catch",
  xlab = "Sea Ice Concentration Same Year (%)",
  ylab = paste0("Krill Catch (", krill_units, ")")
)
...
png(file.path(out_dir, "APEI_yearly_SIC_vs_krill_lags_2x2.png"),
    width = 2400, height = 2400, res = 300)
